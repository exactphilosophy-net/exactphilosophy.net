...
\item
\en{But Leo and Virgo as the central fire resp.\ earth signs do not
fit well with move resp.\ rest.}%
\de{Aber Löwe und Jungfrau als zentrale Feuer- bzw.\ Erdzeichen
passen nicht gut zu sich bewegen bzw.\ ruhen.}
...
\item
\en{Is life {\smaller=} awareness, consciousness, as the basic way of life
to locally reduce entropy, and also {\smaller=} measurement in quantum
mechanics, c.f.\ articles \textsl{Life is awareness\,?}\ and $\!$\textsl{Timeline}\,?}%
\de{Ist Leben {\smaller=} Wahrnehmung, Bewusstsein, als der grundlegende
Weg des Lebens, lokal Entropie zu reduzieren, und auch
{\smaller=} Messung in der Quantenmechanik, vgl.\ die Artikel \textsl{Life is
awareness\,?}\ und $\!$\textsl{Timeline}\,?}
