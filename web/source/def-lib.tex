...
\definecolor{series}{rgb}{0.01,0.71,0.65}
...
% series progress bar
\newcommand{\seriesprogress}[1]{\progressbar[filledcolor=series,emptycolor=white,roundnessr=0,ticksheight=0,tickswidth=0]{#1}}
\newcommand{\seriesminiprogress}[1]{\progressbar[filledcolor=series,emptycolor=white,roundnessr=0,ticksheight=0,tickswidth=0,heightr=0.7,width=2em]{#1}}
